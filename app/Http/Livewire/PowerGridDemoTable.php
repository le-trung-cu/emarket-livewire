...
final class PowerGridDemoTable extends PowerGridComponent
{
    ...
    protected static $demoUsers = null;
    ...
    public function columns(): array
    {
        ...
        return [
            ...
            Column::make('Full name', 'name')
                ...
                ->editOnClick($canEdit, 'name'), //Allows user to edit information on click
    ...
    */
    ...
    {
        if (!is_null(self::$demoUsers)) {
            return self::$demoUsers;
        }
    ...
    public function onUpdatedEditable(string $id, string $field, string $value): void
    {
        ...
        dd( $id, $field, $value, self::$demoUsers);
