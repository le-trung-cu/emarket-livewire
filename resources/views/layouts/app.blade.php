...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
        <!-- Desktop sidebar -->
        <aside class="z-20 hidden overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0"
            :class="[isShowDesktopMenuOpen ? 'w-64' : 'w-20']">
            <div class="text-gray-500 relative dark:text-gray-400 py-4">
                ...
                {{-- @click="isShowDesktopMenuOpen = !isShowDesktopMenuOpen" --}}
                <div>
                    <ul class="mt-6">
                        <li class="relative px-6 py-3">
                            ...
                            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                                ...
                                <span class="ml-4" x-show="isShowDesktopMenuOpen">Dashboard</span>
                            </a>
                        </li>
                    </ul>
                    <ul>
                        <li class="relative px-6 py-3">
                            ...
                            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                                ...
                                <span class="ml-4" x-show="isShowDesktopMenuOpen">Products</span>
                            </a>
                        </li>
                        <li class="relative px-6 py-3">
                            ...
                            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                                ...
                                <span class="ml-4" x-show="isShowDesktopMenuOpen">Categories</span>
                            </a>
                        </li>
                        <li class="relative px-6 py-3">
                            ...
                            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                                ...
                                <span class="ml-4" x-show="isShowDesktopMenuOpen">Orders</span>
                            </a>
                        </li>
                        <li class="relative px-6 py-3">
                            ...
                            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                                ...
                                <span class="ml-4" x-show="isShowDesktopMenuOpen">Settings</span>
                            </a>
                        </li>
                    </ul>
                    <div class="px-6 my-6">
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        ...
                        <li class="relative">
                            <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
                                @click.stop="toggleProfileMenu" @keydown.escape="closeProfileMenu"
