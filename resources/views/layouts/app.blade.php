...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
        <!-- Desktop sidebar -->
        <aside class="z-20 hidden overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0" :class"{'w-64': isSideMenuOpen}">
            <div class="text-gray-500 relative dark:text-gray-400" :class="{'py-4': isSideMenuOpen}">
                <a class=" inset-0 text-lg font-bold text-gray-800 dark:text-gray-200" href="#" @click="isSideMenuOpen = !isSideMenuOpen">
                    Emarket
                </a>
