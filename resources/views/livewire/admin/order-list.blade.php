...
<div>
    ...
    <div>
        ...
        <div class="xl:w-full xl:mx-0 h-12 hidden sm:block bg-white dark:bg-gray-800  shadow rounded">
            <div class="flex border-b px-5 space-x-5">
                <button wire:click="$set('orderStatus', 'all')"
                    class="focus:outline-none focus:text-indigo-700 dark:focus:text-indigo-400 text-sm border-indigo-700 pt-3 rounded-t text-indigo-700 dark:text-indigo-400 cursor-pointer">
                    <div class="flex items-center mb-3">
                        <span class="ml-1 font-normal">All Orders</span>
                    </div>
                    <div  @class(["w-full h-1 bg-indigo-700 rounded-t-md",  "hidden" => $orderStatus !== 'all'])></div>
                </button>
                <button wire:click="$set('orderStatus', 'pending')"
                    ...
                    <div @class(["w-full h-1 bg-indigo-700 rounded-t-md",  "hidden" => $orderStatus !== 'pending'])></div>
                </button>
                <button wire:click="$set('orderStatus', 'registered')"
                    ...
                    <div  @class(["w-full h-1 bg-indigo-700 rounded-t-md",  "hidden" => $orderStatus !== 'restitute'])></div>
                </button>
                <button  wire:click="$set('orderStatus', 'packing')"
                    ...
                    <div  @class(["w-full h-1 bg-indigo-700 rounded-t-md",  "hidden" => $orderStatus !== 'packing'])></div>
                </button>
                ...
                <button  wire:click="$set('orderStatus', 'sent')"
                    ...
                    <div  @class(["w-full h-1 bg-indigo-700 rounded-t-md",  "hidden" => $orderStatus !== 'sent'])></div>
                </button>
                ...
                <button  wire:click="$set('orderStatus', 'complated')"
                    ...
                    <div  @class(["w-full h-1 bg-indigo-700 rounded-t-md",  "hidden" => $orderStatus !== 'complated'])></div>
                </button>
                ...
                <button  wire:click="$set('orderStatus', 'canceled')"
                    ...
                    <div  @class(["w-full h-1 bg-indigo-700 rounded-t-md",  "hidden" => $orderStatus !== 'canceled'])></div>
                </button>
            </div>
        </div>
    </div>
